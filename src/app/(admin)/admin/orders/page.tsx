...
export const metadata = { title: "All Orders | Luxey© Admin" };

const orders = [
    { id: "EPO-32614", customer: "Jerrold Gardner", email: "jg@email.com", items: 23, total: "$116,247.00", date: "01/27/2026", status: "Processing", payment: "Wire" },
    { id: "EPO-32613", customer: "Sarah Connor", email: "sc@email.com", items: 26, total: "$131,410.00", date: "01/27/2026", status: "Verified", payment: "Wire" },
    { id: "EPO-32612", customer: "John Smith", email: "js@email.com", items: 12, total: "$48,200.00", date: "01/26/2026", status: "Shipped", payment: "RTP" },
    { id: "EPO-32611", customer: "Elena Rodriguez", email: "er@email.com", items: 18, total: "$95,120.00", date: "01/25/2026", status: "Complete", payment: "Wire" },
    { id: "EPO-32610", customer: "Michael Thorne", email: "mt@email.com", items: 8, total: "$22,840.00", date: "01/25/2026", status: "Processing", payment: "RTP" },
    { id: "EPO-32609", customer: "David Kim", email: "dk@email.com", items: 15, total: "$74,560.00", date: "01/24/2026", status: "Complete", payment: "Wire" },
    { id: "EPO-32608", customer: "Ana Torres", email: "at@email.com", items: 5, total: "$18,920.00", date: "01/24/2026", status: "Cancelled", payment: "Wire" },
    { id: "EPO-32607", customer: "Marcus Lee", email: "ml@email.com", items: 20, total: "$102,340.00", date: "01/23/2026", status: "Shipped", payment: "Wire" },
];
...
const stats = [
    ...
    { label: "Month Revenue", value: "$4.2M" },
];
            ...
            <div className="flex-1 overflow-y-auto p-10 bg-[#FAFAFA]">
                ...
                <div className="flex gap-4 mb-6">
                    <div className="relative flex-1">
                        ...
                        <input type="text" placeholder="Search by PO#, customer..." className="w-full pl-12 pr-6 py-3 bg-white border border-[#E4E4E4] rounded-sm text-sm font-medium outline-none focus:border-black transition-all" />
                    </div>
                        ...
                        <tbody className="divide-y divide-gray-100">
                            {orders.map((o) => (
                                <tr key={o.id} className="hover:bg-[#FAFAFA] transition-colors">
                                    <td className="p-4 text-sm font-bold">{o.id}</td>
                                    <td className="p-4">
                                        <p className="text-xs font-bold uppercase">{o.customer}</p>
                                        <p className="text-[10px] text-gray-400">{o.email}</p>
                                    </td>
                                    <td className="p-4 text-center text-xs font-bold">{o.items}</td>
                                    <td className="p-4 text-right text-sm font-black price-green">{o.total}</td>
                                    <td className="p-4 text-center">
                                        <span className={`text-[9px] font-black uppercase px-2 py-0.5 rounded ${o.payment === "RTP" ? "bg-blue-50 text-blue-700" : "bg-gray-100 text-gray-600"
                                            }`}>
                                            {o.payment}
                                        </span>
                                    </td>
                                    <td className="p-4 text-xs font-medium text-gray-500">{o.date}</td>
                                    <td className="p-4 text-center">
                                    ...
                                    <td className="p-4 text-right">
                                        <Link href={`/po/${o.id}`} className="text-[10px] font-bold text-gray-400 hover:text-black uppercase underline tracking-widest">
                                            View
                                        </Link>
                                    </td>
                                </tr>
